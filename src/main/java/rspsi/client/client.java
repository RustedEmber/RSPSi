package rspsi.client;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
import rspsi.client.constants.SizeConstants;
import rspsi.client.constants.Skills;
import rspsi.client.graphics.*;
import rspsi.client.net.ISAACRandomGen;
...
public class client extends RSApplet {
	...
	public void setPlayer() {
		myPlayer.name = "Command";
		myPlayer.combatLevel = 126;
		myPlayer.currentHealth = 99;
		myPlayer.anInt1511 = 0;
//		myPlayer.equipment = new int[] {
...
//		};
    ...
    public void updateInterfaces() {
        needDrawTabArea = tabAreaAltered = inputTaken = true;
        aBoolean1149 = false;
    }

    public void clearOverlayInterfaces() {
...
//        stream.createFrame(130);
        openInterfaceID = overlayInterfaceID = -1;
        invInterfaceID = invOverlayInterfaceID = -1;
		dialogID = backDialogID = -1;
    ...
    private void drawChatArea() {
        chatAreaImageProducer.initDrawingArea();
        ...
        if (messagePromptRaised) {
            ...
            drawInterface(0, 0, Interface.interfaceCache[backDialogID], 0);
        else if (dialogID != -1) {
            drawInterface(0, 0, Interface.interfaceCache[dialogID], 0);
        } else {
        ...
        if (menuOpen && menuScreenArea == 2)
            drawMenu();
        chatAreaImageProducer.drawGraphics(357, super.graphics, 17);
        gameAreaImageProducer.initDrawingArea();
        ...
        if (menuOpen) {
            ...
            if (j == 1 && menuActionRow > 0) {
                ...
                if (i1 == 632 || i1 == 78 || i1 == 867 || i1 == 431 || i1 == 53 || i1 == 74 || i1 == 454 || i1 == 539 || i1 == 493 || i1 == 847 || i1 == 447 || i1 == 1125) {
                    ...
                    Interface class9 = Interface.interfaceCache[j2];
                    if (class9.invItemsCanBeSwapped || class9.invSwapDeletesTargetSlot) {
                        aBoolean1242 = false;
                        anInt989 = 0;
                        anInt1084 = j2;
                        anInt1085 = l1;
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
    ...
    private void buildInterfaceMenu(int i, Interface rsi, int k, int l, int i1, int j1) {
        if (rsi.type != 0 || rsi.children == null || rsi.triggered)
            return;
        if (k < i || i1 < l || k > i + rsi.width || i1 > l + rsi.height)
            return;
        int k1 = rsi.children.length;
        for (int l1 = 0; l1 < k1; l1++) {
            int i2 = rsi.childX[l1] + i;
            int j2 = (rsi.childY[l1] + l) - j1;
            Interface rsi_1 = Interface.interfaceCache[rsi.children[l1]];
            i2 += rsi_1.xDrawOffset;
            j2 += rsi_1.yDrawOffset;
            if ((rsi_1.trigger >= 0 || rsi_1.mouseOverDisabledColor != 0) && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height)
                if (rsi_1.trigger >= 0)
                    anInt886 = rsi_1.trigger;
                else
                    anInt886 = rsi_1.id;
            if (rsi_1.type == 8 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height)
                anInt1315 = rsi_1.id;
            if (rsi_1.type == 0) {
                buildInterfaceMenu(i2, rsi_1, k, j2, i1, rsi_1.scrollPosition);
                if (rsi_1.scrollMax > rsi_1.height)
                    method65(i2 + rsi_1.width, rsi_1.height, k, i1, rsi_1, j2, true, rsi_1.scrollMax);
            } else {
                if (rsi_1.actionType == 1 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                    boolean flag = false;
                    if (rsi_1.contentType != 0)
                        flag = buildFriendsListMenu(rsi_1);
                    if (!flag) {
                        //System.out.println("1"+class9_1.tooltip + ", " + class9_1.interfaceID);
                        menuActionName[menuActionRow] = rsi_1.tooltip + ", " + rsi_1.id;
                        menuActionID[menuActionRow] = 315;
                        menuActionCmd3[menuActionRow] = rsi_1.id;
                        menuActionRow++;
                    }
                }
                if (rsi_1.actionType == 2 && spellSelected == 0 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                    String s = rsi_1.selectedActionName;
                    if (s.indexOf(" ") != -1)
                        s = s.substring(0, s.indexOf(" "));
                    menuActionName[menuActionRow] = s + " @gre@" + rsi_1.spellName;
                    menuActionID[menuActionRow] = 626;
                    menuActionCmd3[menuActionRow] = rsi_1.id;
                    menuActionRow++;
                }
                if (rsi_1.actionType == 3 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                    menuActionName[menuActionRow] = "Close";
                    menuActionID[menuActionRow] = 200;
                    menuActionCmd3[menuActionRow] = rsi_1.id;
                    menuActionRow++;
                }
                if (rsi_1.actionType == 4 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                ...
                if (rsi_1.actionType == 5 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                ...
                if (rsi_1.actionType == 6 && !aBoolean1149 && k >= i2 && i1 >= j2 && k < i2 + rsi_1.width && i1 < j2 + rsi_1.height) {
                ...
                if (rsi_1.type == 2) {
                    int k2 = 0;
                    for (int l2 = 0; l2 < rsi_1.height; l2++) {
                        for (int i3 = 0; i3 < rsi_1.width; i3++) {
                            int j3 = i2 + i3 * (32 + rsi_1.invSpritePadX);
                            int k3 = j2 + l2 * (32 + rsi_1.invSpritePadY);
                            if (k2 < 20) {
                                j3 += rsi_1.spritesX[k2];
                                k3 += rsi_1.spritesY[k2];
                            }
                            if (k >= j3 && i1 >= k3 && k < j3 + 32 && i1 < k3 + 32) {
                                mouseInvInterfaceIndex = k2;
                                lastActiveInvInterface = rsi_1.id;
                                if (rsi_1.inv[k2] > 0) {
                                    ItemDef itemDef = ItemDef.forID(rsi_1.inv[k2] - 1);
                                    if (itemSelected == 1 && rsi_1.inventoryInterface) {
                                        if (rsi_1.id != anInt1284 || k2 != anInt1283) {
                                    ...
                                    } else if (spellSelected == 1 && rsi_1.inventoryInterface) {
                                        ...
                                        if (rsi_1.inventoryInterface && itemDef.actions != null) {
                                        ...
                                        if (rsi_1.actions != null) {
                                            for (int j4 = 4; j4 >= 0; j4--)
                                                if (rsi_1.actions[j4] != null) {
                                                    menuActionName[menuActionRow] = rsi_1.actions[j4] + " @lre@" + itemDef.name;
                                                    if (j4 == 0)
                                        ...
                                        menuActionName[menuActionRow] = "Examine @lre@" + itemDef.name + " @gre@(@whi@" + (rsi_1.inv[k2] - 1) + "@gre@)";
...
//                stream.writeWordBigEndian(tradeMode);
            ...
            if (super.saveClickX >= 412 && super.saveClickX <= 512 && super.saveClickY >= 467 && super.saveClickY <= 499)
                if (openInterfaceID == -1) {
                    ...
                    reportAbuseInput = "";
                    canMute = false;
                    for (int i = 0; i < Interface.interfaceCache.length; i++) {
                        if (Interface.interfaceCache[i] == null || Interface.interfaceCache[i].contentType != 600)
                            continue;
                        reportAbuseInterfaceID = openInterfaceID = Interface.interfaceCache[i].parentId;
                        break;
                    }
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                ...
                if (((Entity) (obj)).textSpoken != null && (j >= playerCount || publicChatMode == 0 || publicChatMode == 3 || publicChatMode == 1 && isFriendOrSelf(((Player) obj).name))) {
                    ...
                    if (spriteDrawX > -1 && anInt974 < anInt975) {
                        ...
                        anIntArray978[anInt974] = chatTextDrawingArea.height;
                ...
                if (anInt1249 == 0) {
                    ...
                    if (anIntArray981[k] == 5) {
                        ...
                        if (j4 < 25)
                            ...
                            l4 = j4 - 125;
                        DrawingArea.setDrawingArea(spriteDrawY + 5, 0, 512, spriteDrawY - chatTextDrawingArea.height - 1);
...
//                stream.writeQWord(l);
    ...
    private void drawTabArea() {
        invAreaImageProducer.initDrawingArea();
        Texture.anIntArray1472 = anIntArray1181;
        invBack.method361(0, 0);
        if (invOverlayInterfaceID != -1)
            drawInterface(0, 0, Interface.interfaceCache[invOverlayInterfaceID], 0);
        else if (invInterfaceID != -1)
            drawInterface(0, 0, Interface.interfaceCache[invInterfaceID], 0);
        if (menuOpen && menuScreenArea == 1)
            drawMenu();
        invAreaImageProducer.drawGraphics(205, super.graphics, 553);
        gameAreaImageProducer.initDrawingArea();
        Texture.anIntArray1472 = anIntArray1182;
    }
...
//                }
    ...
    public void processGameLoop() {
        ...
        if (Main.getWorkspace().getMagnifier() != null && Main.magnifierOpen && loopCycle % 20 < 5) //paint magnifier
        	Main.getWorkspace().getMagnifier().paint();
...
//                stream.writeWordBigEndian(canMute ? 1 : 0);
    ...
    private void loadingStages() {
        if (lowMem && loadingStage == 2 && ObjectManager.anInt131 != plane) {
            ...
            gameAreaImageProducer.drawGraphics(4, super.graphics, 4);
            loadingStage = 1;
...
//            stream.createFrame(121);
    ...
    private void method60(int i) {
        Interface class9 = Interface.interfaceCache[i];
        for (int j = 0; j < class9.children.length; j++) {
            if (class9.children[j] == -1)
                break;
            Interface class9_1 = Interface.interfaceCache[class9.children[j]];
            if (class9_1.type == 1)
            ...
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 5) {
                    ...
                    if (lastActiveInvInterface == anInt1084 && mouseInvInterfaceIndex != anInt1085) {
                        Interface class9 = Interface.interfaceCache[anInt1084];
                        int j1 = 0;
                        if (anInt913 == 1 && class9.contentType == 206)
                            j1 = 1;
                        if (class9.inv[mouseInvInterfaceIndex] <= 0)
                            j1 = 0;
                        if (class9.invSwapDeletesTargetSlot) {
                            int l2 = anInt1085;
...
//        }
    ...
    private void resetImageProducers() {
        ...
        chatAreaImageProducer = null;
        mapAreaImageProducer = null;
        invAreaImageProducer = null;
        gameAreaImageProducer = null;
        chatbaseImageProducer = null;
        tabArea2ImageProducer = null;
        tabArea1ImageProducer = null;
...
//            drawLogo();
    ...
    void drawLoadingText(int i, String s) {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        chatTextDrawingArea.drawText(0xffffff, "RSPSi is loading - please wait...", c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
    ...
    private void method65(int i, int j, int k, int l, Interface class9, int i1, boolean flag,
                          int j1) {
        int anInt992;
        if (aBoolean972)
            anInt992 = 32;
    ...
    private void doAction(int i) {
        ...
        if (l == 74) {
            ...
            if (Interface.interfaceCache[k].parentId == openInterfaceID)
                atInventoryInterfaceType = 1;
            if (Interface.interfaceCache[k].parentId == backDialogID)
                atInventoryInterfaceType = 3;
        }
        if (l == 315) {
            Interface class9 = Interface.interfaceCache[k];
            boolean flag8 = true;
        ...
        if (l == 626) {
            Interface class9_1 = Interface.interfaceCache[k];
            spellSelected = 1;
            anInt1137 = k;
        ...
        if (l == 646) {
            //stream.createFrame(185);
            //stream.writeWord(k);
            Interface class9_2 = Interface.interfaceCache[k];
        ...
        if (l == 606) {
            ...
            if (j2 != -1)
                if (openInterfaceID == -1) {
                    ...
                    canMute = false;
                    for (int i3 = 0; i3 < Interface.interfaceCache.length; i3++) {
                        if (Interface.interfaceCache[i3] == null || Interface.interfaceCache[i3].contentType != 600)
                            continue;
                        reportAbuseInterfaceID = openInterfaceID = Interface.interfaceCache[i3].parentId;
                        break;
                    }
        ...
        if (l == 1125) {
            ...
            Interface class9_4 = Interface.interfaceCache[k];
            String s5;
        ...
        if (l == 169) {
            //stream.createFrame(185);
            //stream.writeWord(k);
            Interface class9_3 = Interface.interfaceCache[k];
...
//                        stream.writeQWord(TextClass.longForName(amountOrNameInput));
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    ...
                    if (inputString.startsWith("/")) {
                    	if (inputString.equalsIgnoreCase("/lockmag")) {
                    		if (Main.getWorkspace().getMagnifier() != null)
                    			Main.getWorkspace().getMagnifier().setLocked(true, mouseX, mouseY);
                    	}
...
//                        stream.writeString(inputString.substring(2));
    ...
    private void drawFriendsListOrWelcomeScreen(Interface class9) {
        ...
        if (j == 327) {
            class9.verticalRotation = 150;
            class9.horizontalRotation = (int) (Math.sin((double) loopCycle / 40D) * 256D) & 0x7ff;
            if (aBoolean1031) {
        ...
        if (j == 328) {
            Interface rsinterface = class9; 
            int verticleTilt = 150; 
            int animationSpeed = (int) (Math.sin((double) loopCycle / 40D) * 256D) & 0x7ff; 
            rsinterface.modelZoom = 550; 
            rsinterface.verticalRotation = verticleTilt; 
            rsinterface.horizontalRotation = animationSpeed; 
            if (aBoolean1031) { 
                ...
                characterDisplay.method470(Animation.anims[myPlayer.anInt1511].anIntArray353[0]);
    ...
    private void processTabClick() {
        if (super.clickMode3 == 1) {
//            if (super.saveClickX >= 539 && super.saveClickX <= 573 && super.saveClickY >= 169 && super.saveClickY < 205 && invInterfaceID[0] != -1) {
//                needDrawTabArea = true;
//                tabID = 0;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 569 && super.saveClickX <= 599 && super.saveClickY >= 168 && super.saveClickY < 205 && invInterfaceID[1] != -1) {
//                needDrawTabArea = true;
//                tabID = 1;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 597 && super.saveClickX <= 627 && super.saveClickY >= 168 && super.saveClickY < 205 && invInterfaceID[2] != -1) {
//                needDrawTabArea = true;
//                tabID = 2;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 625 && super.saveClickX <= 669 && super.saveClickY >= 168 && super.saveClickY < 203 && invInterfaceID[3] != -1) {
//                needDrawTabArea = true;
//                tabID = 3;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 666 && super.saveClickX <= 696 && super.saveClickY >= 168 && super.saveClickY < 205 && invInterfaceID[4] != -1) {
//                needDrawTabArea = true;
//                tabID = 4;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 694 && super.saveClickX <= 724 && super.saveClickY >= 168 && super.saveClickY < 205 && invInterfaceID[5] != -1) {
//                needDrawTabArea = true;
//                tabID = 5;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 722 && super.saveClickX <= 756 && super.saveClickY >= 169 && super.saveClickY < 205 && invInterfaceID[6] != -1) {
//                needDrawTabArea = true;
//                tabID = 6;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 540 && super.saveClickX <= 574 && super.saveClickY >= 466 && super.saveClickY < 502 && invInterfaceID[7] != -1) {
//                needDrawTabArea = true;
//                tabID = 7;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 572 && super.saveClickX <= 602 && super.saveClickY >= 466 && super.saveClickY < 503 && invInterfaceID[8] != -1) {
//                needDrawTabArea = true;
//                tabID = 8;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 599 && super.saveClickX <= 629 && super.saveClickY >= 466 && super.saveClickY < 503 && invInterfaceID[9] != -1) {
//                needDrawTabArea = true;
//                tabID = 9;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 627 && super.saveClickX <= 671 && super.saveClickY >= 467 && super.saveClickY < 502 && invInterfaceID[10] != -1) {
//                needDrawTabArea = true;
//                tabID = 10;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 669 && super.saveClickX <= 699 && super.saveClickY >= 466 && super.saveClickY < 503 && invInterfaceID[11] != -1) {
//                needDrawTabArea = true;
//                tabID = 11;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 696 && super.saveClickX <= 726 && super.saveClickY >= 466 && super.saveClickY < 503 && invInterfaceID[12] != -1) {
//                needDrawTabArea = true;
//                tabID = 12;
//                tabAreaAltered = true;
//            }
//            if (super.saveClickX >= 724 && super.saveClickX <= 758 && super.saveClickY >= 466 && super.saveClickY < 502 && invInterfaceID[13] != -1) {
//                needDrawTabArea = true;
//                tabID = 13;
//                tabAreaAltered = true;
//            }
    ...
    private void resetImageProducers2() {
        ...
        aRSImageProducer_1114 = null;
        aRSImageProducer_1115 = null;
        chatAreaImageProducer = new RSImageProducer(479, 96, getGameComponent());
        mapAreaImageProducer = new RSImageProducer(172, 156, getGameComponent());
        DrawingArea.setAllPixelsToZero();
        mapBack.method361(0, 0);
        invAreaImageProducer = new RSImageProducer(190, 261, getGameComponent());
        gameAreaImageProducer = new RSImageProducer(512, 334, getGameComponent());
        DrawingArea.setAllPixelsToZero();
        chatbaseImageProducer = new RSImageProducer(496, 50, getGameComponent());
        tabArea2ImageProducer = new RSImageProducer(269, 37, getGameComponent());
        tabArea1ImageProducer = new RSImageProducer(249, 45, getGameComponent());
        welcomeScreenRaised = true;
    }
    ...
    private void processRightClick() {
        ...
        if (super.mouseX >= 0 && super.mouseY >= 0 && super.mouseX <= 765 && super.mouseY <= 503) {
            if (fullscreenInterfaceID != -1) {
                anInt886 = 0;
                anInt1315 = 0;
                buildInterfaceMenu(0, Interface.interfaceCache[fullscreenInterfaceID], super.mouseX, 10, super.mouseY, 0);
        ...
        if (super.mouseX > 4 && super.mouseY > 4 && super.mouseX < 516 && super.mouseY < 338)
            if (openInterfaceID != -1)
                buildInterfaceMenu(4, Interface.interfaceCache[openInterfaceID], super.mouseX, 4, super.mouseY, 0);
            else
                build3dScreenMenu();
        ...
        if (super.mouseX > 553 && super.mouseY > 205 && super.mouseX < 743 && super.mouseY < 466)
            if (invOverlayInterfaceID != -1)
                buildInterfaceMenu(553, Interface.interfaceCache[invOverlayInterfaceID], super.mouseX, 205, super.mouseY, 0);
            else if (invInterfaceID != -1)
                buildInterfaceMenu(553, Interface.interfaceCache[invInterfaceID], super.mouseX, 205, super.mouseY, 0);
        ...
        if (super.mouseX > 17 && super.mouseY > 357 && super.mouseX < 496 && super.mouseY < 453)
            if (backDialogID != -1)
                buildInterfaceMenu(17, Interface.interfaceCache[backDialogID], super.mouseX, 357, super.mouseY, 0);
    ...
    private void drawGameScreen() {
        if (fullscreenInterfaceID != -1 && (loadingStage == 2 || super.fullGameScreen != null)) {
            if (loadingStage == 2) {
                ...
                DrawingArea.setAllPixelsToZero();
                welcomeScreenRaised = true;
                Interface rsi = Interface.interfaceCache[fullscreenInterfaceID];
                if (rsi.width == 512 && rsi.height == 334 && rsi.type == 0) {
                    rsi.width = 765;
                    rsi.height = 503;
                }
                drawInterface(0, 0, rsi, 10);
                if (openInterfaceID != -1) {
                    Interface rsi_1 = Interface.interfaceCache[openInterfaceID];
                    if (rsi_1.width == 512 && rsi_1.height == 334 && rsi_1.type == 0) {
                        rsi_1.width = 765;
                        rsi_1.height = 503;
                    }
                    drawInterface(0, 0, rsi_1, 10);
                }
                if (!menuOpen) {
                    processRightClick();
                    drawTooltip();
        ...
        if (welcomeScreenRaised) {
            ...
            if (loadingStage != 2) {
                gameAreaImageProducer.drawGraphics(4, super.graphics, 4);
                mapAreaImageProducer.drawGraphics(4, super.graphics, 550);
            }
        }
        if (menuOpen && menuScreenArea == 1)
            needDrawTabArea = true;
...
//                stream.writeWordBigEndian(tabID);
            ...
            tabArea1ImageProducer.initDrawingArea();
            backHmid1.method361(0, 0);
//            if (invOverlayInterfaceID == -1) {
//                if (invInterfaceID[tabID] != -1) {
//                    if (tabID == 0)
...
//                }
//                if (invInterfaceID[0] != -1 && (anInt1054 != 0 || loopCycle % 20 < 10))
//                    sideIcons[0].method361(29, 13);
//                if (invInterfaceID[1] != -1 && (anInt1054 != 1 || loopCycle % 20 < 10))
//                    sideIcons[1].method361(53, 11);
//                if (invInterfaceID[2] != -1 && (anInt1054 != 2 || loopCycle % 20 < 10))
//                    sideIcons[2].method361(82, 11);
//                if (invInterfaceID[3] != -1 && (anInt1054 != 3 || loopCycle % 20 < 10))
//                    sideIcons[3].method361(115, 12);
//                if (invInterfaceID[4] != -1 && (anInt1054 != 4 || loopCycle % 20 < 10))
//                    sideIcons[4].method361(153, 13);
//                if (invInterfaceID[5] != -1 && (anInt1054 != 5 || loopCycle % 20 < 10))
//                    sideIcons[5].method361(180, 11);
//                if (invInterfaceID[6] != -1 && (anInt1054 != 6 || loopCycle % 20 < 10))
//                    sideIcons[6].method361(208, 13);
//            }
            tabArea1ImageProducer.drawGraphics(160, super.graphics, 516);
            tabArea2ImageProducer.initDrawingArea();
...
//                }
//                if (invInterfaceID[8] != -1 && (anInt1054 != 8 || loopCycle % 20 < 10))
//                    sideIcons[7].method361(74, 2);
//                if (invInterfaceID[9] != -1 && (anInt1054 != 9 || loopCycle % 20 < 10))
//                    sideIcons[8].method361(102, 3);
//                if (invInterfaceID[10] != -1 && (anInt1054 != 10 || loopCycle % 20 < 10))
//                    sideIcons[9].method361(137, 4);
//                if (invInterfaceID[11] != -1 && (anInt1054 != 11 || loopCycle % 20 < 10))
//                    sideIcons[10].method361(174, 2);
//                if (invInterfaceID[12] != -1 && (anInt1054 != 12 || loopCycle % 20 < 10))
//                    sideIcons[11].method361(201, 2);
//                if (invInterfaceID[13] != -1 && (anInt1054 != 13 || loopCycle % 20 < 10))
//                    sideIcons[12].method361(226, 2);
//            }
            tabArea2ImageProducer.drawGraphics(466, super.graphics, 496);
            gameAreaImageProducer.initDrawingArea();
        }
        if (aBoolean1233) {
            aBoolean1233 = false;
            chatbaseImageProducer.initDrawingArea();
            ...
            chatbaseImageProducer.drawGraphics(453, super.graphics, 0);
            gameAreaImageProducer.initDrawingArea();
        }
        anInt945 = 0;
    }
    ...
    private void drawInterface(int j, int k, Interface parent, int l) {
        if (parent.type != 0 || parent.children == null)
            return;
        if (parent.triggered && anInt1026 != parent.id && anInt1048 != parent.id && anInt1039 != parent.id)
            return;
        int i1 = DrawingArea.topX;
        int j1 = DrawingArea.topY;
        int k1 = DrawingArea.bottomX;
        int l1 = DrawingArea.bottomY;
        DrawingArea.setDrawingArea(l + parent.height, k, k + parent.width, l);
        int i2 = parent.children.length;
        for (int j2 = 0; j2 < i2; j2++) {
            int k2 = parent.childX[j2] + k;
            int l2 = (parent.childY[j2] + l) - j;
            Interface rsi = Interface.interfaceCache[parent.children[j2]];
            k2 += rsi.xDrawOffset;
            l2 += rsi.yDrawOffset;
            if (rsi.contentType > 0)
                drawFriendsListOrWelcomeScreen(rsi);
            if (rsi.type == 0) {
                if (rsi.scrollPosition > rsi.scrollMax - rsi.height)
                    rsi.scrollPosition = rsi.scrollMax - rsi.height;
                if (rsi.scrollPosition < 0)
                    rsi.scrollPosition = 0;
                drawInterface(rsi.scrollPosition, k2, rsi, l2);
                if (rsi.scrollMax > rsi.height)
                    method30(rsi.height, rsi.scrollPosition, l2, k2 + rsi.width, rsi.scrollMax);
            } else if (rsi.type != 1)
                if (rsi.type == 2) {
                    int i3 = 0;
                    for (int l3 = 0; l3 < rsi.height; l3++) {
                        for (int l4 = 0; l4 < rsi.width; l4++) {
                            int k5 = k2 + l4 * (32 + rsi.invSpritePadX);
                            int j6 = l2 + l3 * (32 + rsi.invSpritePadY);
                            if (i3 < 20) {
                                k5 += rsi.spritesX[i3];
                                j6 += rsi.spritesY[i3];
                            }
                            if (rsi.inv[i3] > 0) {
                                ...
                                if (k5 > DrawingArea.topX - 32 && k5 < DrawingArea.bottomX && j6 > DrawingArea.topY - 32 && j6 < DrawingArea.bottomY || activeInterfaceType != 0 && anInt1085 == i3) {
                                    int l9 = 0;
                                    if (itemSelected == 1 && anInt1283 == i3 && anInt1284 == rsi.id)
                                        l9 = 0xffffff;
                                    Sprite class30_sub2_sub1_sub1_2 = ItemDef.getSprite(j9, rsi.invStackSizes[i3], l9);
                                    if (class30_sub2_sub1_sub1_2 != null) {
                                        if (activeInterfaceType != 0 && anInt1085 == i3 && anInt1084 == rsi.id) {
                                            ...
                                            if (j6 + j7 < DrawingArea.topY && parent.scrollPosition > 0) {
                                            ...
                                            if (j6 + j7 + 32 > DrawingArea.bottomY && parent.scrollPosition < parent.scrollMax - parent.height) {
                                        ...
                                        if (atInventoryInterfaceType != 0 && atInventoryIndex == i3 && atInventoryInterface == rsi.id)
                                            class30_sub2_sub1_sub1_2.drawSprite1(k5, j6);
                                        else
                                            class30_sub2_sub1_sub1_2.drawSprite(k5, j6);
                                        if (class30_sub2_sub1_sub1_2.anInt1444 == 33 || rsi.invStackSizes[i3] != 1) {
                                            int k10 = rsi.invStackSizes[i3];
                            ...
                            } else if (rsi.sprites != null && i3 < 20) {
                                Sprite class30_sub2_sub1_sub1_1 = rsi.sprites[i3];
                    ...
                    boolean flag = false;
                    if (anInt1039 == rsi.id || anInt1048 == rsi.id || anInt1026 == rsi.id)
                        flag = true;
                    int j3;
                    if (interfaceIsSelected(rsi)) {
                        j3 = rsi.enabledColor;
                        if (flag && rsi.mouseOverEnabledColor != 0)
                            j3 = rsi.mouseOverEnabledColor;
                    } else {
                        j3 = rsi.disabledColor;
                        if (flag && rsi.mouseOverDisabledColor != 0)
                            j3 = rsi.mouseOverDisabledColor;
                    }
                    if (rsi.alpha == 0) {
                        if (rsi.filled)
                            DrawingArea.method336(rsi.height, l2, k2, j3, rsi.width);
                        else
                            DrawingArea.fillPixels(k2, rsi.width, rsi.height, j3, l2);
                    } else if (rsi.filled)
                        DrawingArea.method335(j3, l2, rsi.width, rsi.height, 256 - (rsi.alpha & 0xff), k2);
                    else
                        DrawingArea.method338(l2, rsi.height, 256 - (rsi.alpha & 0xff), j3, rsi.width, k2);
                } else if (rsi.type == 4) {
                    TextDrawingArea textDrawingArea = rsi.fontStyle;
                    String s = rsi.disabledText;
                    boolean flag1 = false;
                    if (anInt1039 == rsi.id || anInt1048 == rsi.id || anInt1026 == rsi.id)
                        flag1 = true;
                    int i4;
                    if (interfaceIsSelected(rsi)) {
                        i4 = rsi.enabledColor;
                        if (flag1 && rsi.mouseOverEnabledColor != 0)
                            i4 = rsi.mouseOverEnabledColor;
                        if (rsi.enabledText.length() > 0)
                            s = rsi.enabledText;
                    } else {
                        i4 = rsi.disabledColor;
                        if (flag1 && rsi.mouseOverDisabledColor != 0)
                            i4 = rsi.mouseOverDisabledColor;
                    }
                    if (rsi.actionType == 6 && aBoolean1149) {
                        s = "Please wait...";
                        i4 = rsi.disabledColor;
                    }
                    ...
                    for (int l6 = l2 + textDrawingArea.height; s.length() > 0; l6 += textDrawingArea.height) {
                        if (s.indexOf("%") != -1) {
                            do {
                                int k7 = s.indexOf("%1");
                                if (k7 == -1)
                                    break;
                                s = s.substring(0, k7) + interfaceIntToString(extractInterfaceValues(rsi, 0)) + s.substring(k7 + 2);
                            } while (true);
                            do {
                                int l7 = s.indexOf("%2");
                                if (l7 == -1)
                                    break;
                                s = s.substring(0, l7) + interfaceIntToString(extractInterfaceValues(rsi, 1)) + s.substring(l7 + 2);
                            } while (true);
                            do {
                                int i8 = s.indexOf("%3");
                                if (i8 == -1)
                                    break;
                                s = s.substring(0, i8) + interfaceIntToString(extractInterfaceValues(rsi, 2)) + s.substring(i8 + 2);
                            } while (true);
                            do {
                                int j8 = s.indexOf("%4");
                                if (j8 == -1)
                                    break;
                                s = s.substring(0, j8) + interfaceIntToString(extractInterfaceValues(rsi, 3)) + s.substring(j8 + 2);
                            } while (true);
                            do {
                                int k8 = s.indexOf("%5");
                                if (k8 == -1)
                                    break;
                                s = s.substring(0, k8) + interfaceIntToString(extractInterfaceValues(rsi, 4)) + s.substring(k8 + 2);
                            } while (true);
                        }
                        int l8 = s.indexOf("\\n");
                        String s1;
                        ...
                        if (rsi.centered)
                            textDrawingArea.method382(i4, k2 + rsi.width / 2, s1, l6, rsi.shadowed);
                        else
                            textDrawingArea.method389(rsi.shadowed, k2, i4, s1, l6);
                    }

                } else if (rsi.type == 5) {
                    Sprite sprite;
                    if (interfaceIsSelected(rsi))
                        sprite = rsi.enabledSprite;
                    else
                        sprite = rsi.disabledSprite;
                    if (sprite != null)
                        sprite.drawSprite(k2, l2);
                } else if (rsi.type == 6) {
                    int k3 = Texture.textureInt1;
                    int j4 = Texture.textureInt2;
                    Texture.textureInt1 = k2 + rsi.width / 2;
                    Texture.textureInt2 = l2 + rsi.height / 2;
                    int i5 = Texture.anIntArray1470[rsi.verticalRotation] * rsi.modelZoom >> 16;
                    int l5 = Texture.anIntArray1471[rsi.verticalRotation] * rsi.modelZoom >> 16;
                    boolean flag2 = interfaceIsSelected(rsi);
                    int i7;
                    if (flag2)
                        i7 = rsi.enabledAnimation;
                    else
                        i7 = rsi.disabledAnimation;
                    Model model;
                    if (i7 == -1) {
                        model = rsi.method209(-1, -1, flag2);
                    } else {
                        Animation animation = Animation.anims[i7];
                        model = rsi.method209(animation.anIntArray354[rsi.animationFrame], animation.anIntArray353[rsi.animationFrame], flag2);
                    }
                    if (model != null)
                        model.method482(rsi.horizontalRotation, 0, rsi.verticalRotation, 0, i5, l5);
                    Texture.textureInt1 = k3;
                    Texture.textureInt2 = j4;
                } else if (rsi.type == 7) {
                    TextDrawingArea textDrawingArea_1 = rsi.fontStyle;
                    int k4 = 0;
                    for (int j5 = 0; j5 < rsi.height; j5++) {
                        for (int i6 = 0; i6 < rsi.width; i6++) {
                            if (rsi.inv[k4] > 0) {
                                ItemDef itemDef = ItemDef.forID(rsi.inv[k4] - 1);
                                String s2 = itemDef.name;
                                if (itemDef.stackable || rsi.invStackSizes[k4] != 1)
                                    s2 = s2 + " x" + intToKOrMilLongName(rsi.invStackSizes[k4]);
                                int i9 = k2 + i6 * (115 + rsi.invSpritePadX);
                                int k9 = l2 + j5 * (12 + rsi.invSpritePadY);
                                if (rsi.centered)
                                    textDrawingArea_1.method382(rsi.disabledColor, i9 + rsi.width / 2, s2, k9, rsi.shadowed);
                                else
                                    textDrawingArea_1.method389(rsi.shadowed, i9, rsi.disabledColor, s2, k9);
                            }
                            k4++;
                        }
                ...
                } else if (rsi.type == 8 && (anInt1500 == rsi.id || anInt1044 == rsi.id || anInt1129 == rsi.id) && anInt1501 == 75) {
                    int boxWidth = 0;
                    int boxHeight = 0;
                    TextDrawingArea textDrawingArea_2 = aTextDrawingArea_1271;
                    for (String s1 = rsi.disabledText; s1.length() > 0;) {
                        int l7 = s1.indexOf("\\n");
                        String s4;
                        if (l7 != -1) {
                        ...
                        boxHeight += textDrawingArea_2.height + 1;
                    }
                    boxWidth += 6;
                    boxHeight += 7;
                    ...
                    if (xPos < k2 + 5)
                        xPos = k2 + 5;
                    if (xPos + boxWidth > k + parent.width)
                        xPos = (k + parent.width) - boxWidth;
                    if (yPos + boxHeight > l + parent.height)
    					yPos = (l2 - boxHeight);
//                        yPos = (l + parent.height) - boxHeight;
                    DrawingArea.method336(boxHeight, yPos, xPos, 0xFFFFA0, boxWidth);
                    DrawingArea.fillPixels(xPos, boxWidth, boxHeight, 0, yPos);
                    String s2 = rsi.disabledText;
                    for (int j11 = yPos + textDrawingArea_2.height + 2; s2.length() > 0; j11 += textDrawingArea_2.height + 1) {//anInt1497
                        int l11 = s2.indexOf("\\n");
                        String s5;
                        if (l11 != -1) {
        ...
        if (Main.showReference && Main.reference != null) { //custom
        	int topX = 0, topY = 0;
        	switch (Main.region) {
    		case 2:
    			topX += 17;
        	...
        	Main.reference.drawSprite1(topX, topY);
        }

		int color = 0xeeeeee;
        if (Main.outline && Main.editing != null)
        	for (int abc = 0; abc < Main.editing.length; abc++) {
        		if (Main.editingParents[abc] == parent) {
	        		Interface rsi_1 = Main.editing[abc];
	        		int topX = 0, topY = 0;

	        		if (Main.editingParents[abc] != Main.topParent) {
	        			topX += Main.topParent.childX[Main.parentLayers[abc]];
	        			topY += Main.topParent.childY[Main.parentLayers[abc]];
	        			topY -= Interface.interfaceCache[Main.topParent.children[Main.parentLayers[abc]]].scrollPosition;
	        		}
	
	        		if (Main.editingLayers[abc] >= 0) {
	        			topX += parent.childX[Main.editingLayers[abc]];
		    			topY += parent.childY[Main.editingLayers[abc]];
	        		}
	                ...
	                DrawingArea.fillPixels(topX - 1, rsi_1.width + 2, rsi_1.height + 2, color, topY - 1);
//                    DrawingArea.method338(topY - 1, rsi_1.height + 2, 256, color, rsi_1.width + 2, topX - 1);
	        		if (Main.shaded)
	        			DrawingArea.method335(color, topY, rsi_1.width, rsi_1.height, 256 - ((byte) 128 & 0xff), topX);
	//        		DrawingArea.method336(rsi_1.width + 2, topY, topX, 0xFFFFA0, rsi_1.height + 2);
...
//            }
        ...
        if (overlayInterfaceID != -1) {
            method119(anInt945, overlayInterfaceID);
            drawInterface(0, 0, Interface.interfaceCache[overlayInterfaceID], 0);
        }
        if (openInterfaceID != -1) {
            method119(anInt945, openInterfaceID);
...
//            stream.writeQWord(l);
    ...
    private boolean method119(int i, int j) {
        boolean flag1 = false;
        Interface class9 = Interface.interfaceCache[j];
        for (int k = 0; k < class9.children.length; k++) {
            if (class9.children[k] == -1)
                break;
            Interface class9_1 = Interface.interfaceCache[class9.children[k]];
            if (class9_1.type == 1)
            ...
            if (class9_1.type == 6 && (class9_1.disabledAnimation != -1 || class9_1.enabledAnimation != -1)) {
                ...
                if (l != -1) {
                    ...
                    for (class9_1.anInt208 += i; class9_1.anInt208 > animation.method258(class9_1.animationFrame);) {
                        class9_1.anInt208 -= animation.method258(class9_1.animationFrame) + 1;
                        class9_1.animationFrame++;
                        if (class9_1.animationFrame >= animation.anInt352) {
                            class9_1.animationFrame -= animation.anInt356;
                            if (class9_1.animationFrame < 0 || class9_1.animationFrame >= animation.anInt352)
                                class9_1.animationFrame = 0;
                        }
                        flag1 = true;
                    }
        ...
        try {
            ...
            do {
                ...
                if (j1 == 3)
                    k1 = currentExp[ai[l++]];
                if (j1 == 4) {
                    Interface class9_1 = Interface.interfaceCache[ai[l++]];
                    int k2 = ai[l++];
                ...
                if (j1 == 10) {
                    Interface class9_2 = Interface.interfaceCache[ai[l++]];
                    int l2 = ai[l++] + 1;
        ...
        try {
            ...
            if (pktType == 176) {
                ...
                if (anInt1193 != 0 && openInterfaceID == -1) {
                    ...
                    reportAbuseInput = "";
                    canMute = false;
                    for (int k9 = 0; k9 < Interface.interfaceCache.length; k9++) {
                        if (Interface.interfaceCache[k9] == null || Interface.interfaceCache[k9].contentType != c)
                            continue;
                        openInterfaceID = Interface.interfaceCache[k9].parentId;
                        break;
                    }
            ...
            if (pktType == 185) {
                ...
                Interface.interfaceCache[k].disabledMediaType = 3;
                if (myPlayer.desc == null)
                    Interface.interfaceCache[k].disabledMediaId = (myPlayer.anIntArray1700[0] << 25) + (myPlayer.anIntArray1700[4] << 20) + (myPlayer.equipment[0] << 15) + (myPlayer.equipment[8] << 10) + (myPlayer.equipment[11] << 5) + myPlayer.equipment[1];
                else
                    Interface.interfaceCache[k].disabledMediaId = (int) (0x12345678L + myPlayer.desc.type);
                pktType = -1;
                return true;
            }
            if (pktType == 107) {
            ...
            if (pktType == 72) {
                ...
                Interface class9 = Interface.interfaceCache[i1];
            ...
            if (pktType == 70) {
                ...
                Interface class9_5 = Interface.interfaceCache[i16];
                class9_5.xDrawOffset = k2;
                class9_5.yDrawOffset = l10;
                pktType = -1;
                return true;
            }
            ...
            if (pktType == 75) {
                ...
                Interface.interfaceCache[j11].disabledMediaType = 2;
                Interface.interfaceCache[j11].disabledMediaId = j3;
                pktType = -1;
                return true;
            }
            if (pktType == 114) {
            ...
            if (pktType == 79) {
                ...
                Interface class9_3 = Interface.interfaceCache[j5];
            ...
            if (pktType == 246) {
                ...
                if (k18 == 65535) {
                    Interface.interfaceCache[i6].disabledMediaType = 0;
                    pktType = -1;
                    return true;
                } else {
                    ItemDef itemDef = ItemDef.forID(k18);
                    Interface.interfaceCache[i6].disabledMediaType = 4;
                    Interface.interfaceCache[i6].disabledMediaId = k18;
                    Interface.interfaceCache[i6].verticalRotation = itemDef.modelRotation1;
                    Interface.interfaceCache[i6].horizontalRotation = itemDef.modelRotation2;
                    Interface.interfaceCache[i6].modelZoom = (itemDef.modelZoom * 100) / i13;
                    pktType = -1;
                    return true;
                }
            }
            if (pktType == 171) {
                ...
                Interface.interfaceCache[j13].triggered = flag1;
                pktType = -1;
                return true;
            }
            if (pktType == 142) {
            ...
            if (pktType == 126) {
                ...
                Interface.interfaceCache[k13].disabledText = s1;
                if (Interface.interfaceCache[k13].parentId == invInterfaceID)
                    needDrawTabArea = true;
                pktType = -1;
                return true;
            }
            ...
            if (pktType == 8) {
                ...
                Interface.interfaceCache[k6].disabledMediaType = 1;
                Interface.interfaceCache[k6].disabledMediaId = l13;
                pktType = -1;
                return true;
            }
            if (pktType == 122) {
                ...
                int i22 = i14 >> 5 & 0x1f;
                int l24 = i14 & 0x1f;
                Interface.interfaceCache[l6].disabledColor = (i19 << 19) + (i22 << 11) + (l24 << 3);
                pktType = -1;
                return true;
            }
            if (pktType == 53) {
                ...
                Interface class9_1 = Interface.interfaceCache[i7];
            ...
            if (pktType == 230) {
                ...
                Interface.interfaceCache[j14].verticalRotation = k19;
                Interface.interfaceCache[j14].horizontalRotation = k22;
            ...
            if (pktType == 200) {
                ...
                Interface class9_4 = Interface.interfaceCache[l8];
            ...
            if (pktType == 34) {
                ...
                Interface class9_2 = Interface.interfaceCache[i9];
                while (inStream.currentOffset < pktSize) {
...
//        stream.createFrame(130);
    ...
    public final Interface aClass9_1059;
    ...
    public RSImageProducer chatbaseImageProducer;
    public RSImageProducer tabArea2ImageProducer;
    public RSImageProducer tabArea1ImageProducer;
    public static Player myPlayer;
    public final String[] atPlayerActions;
    public final boolean[] atPlayerArray;
    public final int[][][] anIntArrayArrayArray1129;
    public int invInterfaceID;
    ...
    public RSImageProducer invAreaImageProducer;
    public RSImageProducer mapAreaImageProducer;
    public RSImageProducer gameAreaImageProducer;
    public RSImageProducer chatAreaImageProducer;

package rspsi.client.graphics;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public final class TextDrawingArea extends DrawingArea {
    ...
    public void method389(boolean flag1, int i, int j, String s, int k) {
        ...
        if (aBoolean1499)
            method339(k + (int) ((double) height * 0.69999999999999996D), 0x800000, i - l, l);
    }
